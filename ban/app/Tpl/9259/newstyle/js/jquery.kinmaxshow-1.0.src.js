    ...
    $.fn.kinMaxShow = function (user_options) {
        ...
        var default_options = {
            ...
            button: {
                ...
                normal: { width: '70px', height: '6px', lineHeight: '14px', left: '10px', bottom: '10px', fontSize: '10px', background: "#000", color: "#666666", textAlign: 'center', margin: '20px 6px', fontFamily: "Verdana", float: 'left', filter:'alpha(opacity=10)',opacity:'0.1'},
                //当前 按钮样式
                focus: { background: "#fff", filter:'alpha(opacity=100)',opacity:'1' }
            },
        ...
        k.setAnimate = function () {
            ...
            $('#prev').click(function () {
                ...
                function setChange() {
                    if ($(".focus").index() == 0) {
                        k.index = $("#kinMaxShow a").length - 1;
                    } else {
                        k.index = $(".focus").index() - 1;
                    }
                    k.setOpacity();
                }
                if (options.button.switchEvent == 'mouseover') {
            ...
            $('#next').click(function () {
                _this = this;
                function setChange() {
                    if ($(".focus").index() == $("#kinMaxShow a").length - 1) {
                        k.index = 0;
                    } else {
                        k.index = $(".focus").index() + 1;
                    }
        ...
        k.run = function () {
            k.onload();
            /*居中*/
            var t = $('ul.' + k.prename + 'button li', k.self).parent();
            t.css('left', '50%');
            var leftObj = -t.width() / 2;
            t.css('marginLeft', leftObj);
        };
