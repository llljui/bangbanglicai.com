...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        ...
        fontColor: '#ff4f4f', //font color
        fontFamily: 'PingFang SC,Lantinghei SC,Microsoft Yahei,Hiragino Sans GB,Microsoft Sans Serif,WenQuanYi Micro Hei,sans', //defines font family
        fontWeight: '200', //defines font weight
